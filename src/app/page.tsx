  ...
  return (
    <>
      ...
      <p className="mt-4 mb-5">
        In this simulation, you start with 100 gold coins.  You can hire adventurers to take
        care of a random issue plaguing your town or village.   If you can defeat two challenges
        before running out of gold, you win!
      </p>
      <p className="mt-4 mb-5">
        ...
        Hiring the adventurers will deduct from your stash of gold coins.
      </p>
      <p className="mt-4 mb-5">
        Once you have hired your adventurers on the cart page, you will be taken to the resolution page
        which will display the random monster(s) that are causing the ruckus, and weather or not your
      ...
      <p>
        ...
        you refresh the page. This will be rectified in a future version.
      </p>
      <p className="mt-4 mb-5">
